    ...
    return (
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <Link href={redirect ? `/auth/signin?redirect=${encodeURIComponent(redirect)}` : "/auth/signin"}>
          ...
          <div className="space-y-2">
            ...
            <Link href={redirect || "/"}>
              <Button variant="outline" className="w-full">
                {redirect ? "Go to Destination" : "Go to Home"}
              </Button>
            </Link>
          </div>
        </CardContent>
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="space-y-2">
            ...
            <Link href={redirect ? `/auth/signup?redirect=${encodeURIComponent(redirect)}` : "/auth/signup"}>
              <Button variant="outline" className="w-full">
                Create New Account
              </Button>
            </Link>
